...
import tech.techyinc.television.ui.TvUtil.diffCallback
import tech.techyinc.television.ui.TvUtil.metadataDiffCallback
...
import tech.techyinc.television.ui.preferences.PreferencesActivity
import tech.techyinc.television.viewmodel.MainTvModel
import tech.techyinc.television.viewmodel.MainTvModel.Companion.getMainTvModel
import tech.techyinc.vlc.BuildConfig
import tech.techyinc.vlc.R
import tech.techyinc.vlc.RecommendationsService
...
//        rowsAdapter.add(playlistRow)
        ...
        otherAdapter.add(GenericCardItem(ID_PRIVACY_POLICY, getString(R.string.privacyPolicy), "", R.drawable.ic_menu_info_big, R.color.tv_card_content_dark))
        ...
        when (row?.id) {
            ...
            HEADER_MISC -> {
                when ((item as GenericCardItem).id) {
                    ...
                    ID_PRIVACY_POLICY -> activity.startActivity((Intent(activity,PolicyActivity::class.java)))
