...
import tech.techyinc.moviepedia.database.models.MediaMetadataType
import tech.techyinc.moviepedia.database.models.getYear
import tech.techyinc.moviepedia.database.models.subtitle
import tech.techyinc.moviepedia.database.models.tvEpisodeSubtitle
import tech.techyinc.moviepedia.repository.MediaMetadataRepository
import tech.techyinc.resources.CONTENT_EPISODE
import tech.techyinc.resources.CONTENT_RESUME
import tech.techyinc.tools.Settings
import tech.techyinc.vlc.BuildConfig
import tech.techyinc.vlc.R
import tech.techyinc.vlc.getFileUri
                        ...
                        mediaMetadataWithImages.metadata.mlId?.let { mlId ->
                            ...
                            matrixCursor.addRow(arrayOf(media.id, "media_${media.id}", mediaMetadataWithImages.metadata.title, mediaMetadataWithImages.subtitle(), thumbnail, mediaMetadataWithImages.metadata.getYear(), media.length))
                                ...
                                ?: if (mediaMetadataWithImages.metadata.type == MediaMetadataType.TV_SHOW) {
                                    val provider = tech.techyinc.moviepedia.provider.MediaScrapingTvshowProvider(context)
