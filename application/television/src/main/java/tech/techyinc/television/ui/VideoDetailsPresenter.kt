...
import tech.techyinc.television.databinding.TvVideoDetailsBinding
import tech.techyinc.television.R

class VideoDetailsPresenter(private val context: Context, private val screenWidth: Int) : tech.techyinc.television.ui.FullWidthRowPresenter() {
    ...
    override fun onBindRowViewHolder(viewHolder: ViewHolder, item: Any?) {
        ...
        val metadata = (item as tech.techyinc.television.ui.VideoDetailsOverviewRow).item
