...
package tech.techyinc.vlc.database
...
import tech.techyinc.vlc.database.helpers.*
import tech.techyinc.vlc.util.TestUtil
import tech.techyinc.vlc.util.getValue
...
class MigrationTest {
    ...
    @Test fun migrateFrom26() {
        ...
        val slave: tech.techyinc.vlc.mediadb.models.Slave = migratedDb.slaveDao().get(slaveMedia1Path)[0]
        val exSub: List<tech.techyinc.vlc.mediadb.models.ExternalSub> = getValue(migratedDb.externalSubDao().get(exSubMedia1Name))
        val fav: tech.techyinc.vlc.mediadb.models.BrowserFav = migratedDb.browserFavDao().get(favUri)[0]
