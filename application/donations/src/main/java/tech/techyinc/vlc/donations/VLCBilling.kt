...
package tech.techyinc.vlc.donations

import android.app.Application
import android.content.IntentFilter
import android.util.Log
import tech.techyinc.tools.SingletonHolder
import tech.techyinc.vlc.donations.util.*
...
class VLCBilling private constructor(private val context: Application) : IabBroadcastReceiver.IabBroadcastListener, IabHelper.QueryInventoryFinishedListener {
    ...
    val skuList = arrayListOf(DONATION_TIER_1, DONATION_TIER_2, DONATION_TIER_3, DONATION_TIER_4, DONATION_TIER_5, SUBSCRIPTION_TIER_1, SUBSCRIPTION_TIER_2, SUBSCRIPTION_TIER_3, SUBSCRIPTION_TIER_4, SUBSCRIPTION_TIER_5)
