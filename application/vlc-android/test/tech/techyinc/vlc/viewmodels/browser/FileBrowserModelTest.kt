...
class FileBrowserModelTest : BaseTest() {
    ...
    private fun getFakeBrowserFav(index: Int): tech.techyinc.vlc.mediadb.models.BrowserFav {
        val t = temporaryFolder.newFile("fake_media$index")
        return tech.techyinc.vlc.mediadb.models.BrowserFav(t.path.toUri(), 0, "vid_$index", null)
    }
    ...
    fun whenAtRootAndHasLocalFavorite_checkDataSetContainsIt() {
        val liveFavorites: MutableLiveData<List<tech.techyinc.vlc.mediadb.models.BrowserFav>> = MutableLiveData()
