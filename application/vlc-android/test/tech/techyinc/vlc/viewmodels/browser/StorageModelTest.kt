...
class StorageModelTest : BaseTest() {
    ...
    fun whenAtRootAndTwoCustomDirectoriesWithOneChildOfInternalStorage_checkTwoResultsAreObtained() {
        val customDir = tech.techyinc.vlc.mediadb.models.CustomDirectory(temporaryFolder.newFile("custom1").path)
        ...
        val customDirInsideInternalStorage = tech.techyinc.vlc.mediadb.models.CustomDirectory(newDirInsideInternalStorage.path)
    ...
    fun whenAtCustomDirAndHiddenDirectoryPresentWithHideHiddenFiles_checkResultHasCorrectDirectoriesAndFlagIsNotShowHiddenFiles() {
        val customDir = tech.techyinc.vlc.mediadb.models.CustomDirectory(temporaryFolder.root.path)
