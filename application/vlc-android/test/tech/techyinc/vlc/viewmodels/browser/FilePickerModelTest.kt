...
class FilePickerModelTest : BaseTest() {
    ...
    init {
        ...
        BrowserProvider.registerCreator(clazz = CoroutineContextProvider::class.java) { tech.techyinc.vlc.util.TestCoroutineContextProvider() }
    }
    ...
    override fun beforeTest() {
        ...
        browserModel = BrowserModel(application, dummyUrl, TYPE_PICKER, false, true, tech.techyinc.vlc.util.TestCoroutineContextProvider())
