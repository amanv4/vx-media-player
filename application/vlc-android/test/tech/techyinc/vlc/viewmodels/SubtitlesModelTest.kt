...
import tech.techyinc.resources.opensubtitles.OpenSubtitleRepository
...
class SubtitlesModelTest : BaseTest() {
    ...
    private val downloadedLiveData = MutableLiveData<List<tech.techyinc.vlc.mediadb.models.ExternalSub>>()
