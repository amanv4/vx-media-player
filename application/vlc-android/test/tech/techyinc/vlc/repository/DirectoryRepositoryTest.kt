...
import tech.techyinc.vlc.util.argumentCaptor
import tech.techyinc.vlc.util.uninitialized
...
class DirectoryRepositoryTest {
    ...
    fun insertTwoCustomDirectory_GetAllShouldReturnTwo() = runBlocking{
        ...
        val inserted = argumentCaptor<tech.techyinc.vlc.mediadb.models.CustomDirectory>()
    ...
    fun insertTwoCustomDirectory_DeleteOneShouldDeleteOne() = runBlocking{
        ...
        val deleted = argumentCaptor<tech.techyinc.vlc.mediadb.models.CustomDirectory>()
