...
class ExternalSubRepositoryTest {
    ...
    @Test fun saveTwoSubtitleForTwoMedia_GetShouldReturnZero() = runBlocking {
        ...
        val inserted = argumentCaptor<tech.techyinc.vlc.mediadb.models.ExternalSub>()
        ...
        val fakeFooLiveDataSubtitles = MutableLiveData<List<tech.techyinc.vlc.mediadb.models.ExternalSub>>()
        val fakeBarLiveDataSubtitles = MutableLiveData<List<tech.techyinc.vlc.mediadb.models.ExternalSub>>()
