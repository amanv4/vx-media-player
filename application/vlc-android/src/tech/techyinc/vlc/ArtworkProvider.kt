 ...
 * content://tech.techyinc.vlc.artwork/album/<track count>/<id>
 * content://tech.techyinc.vlc.artwork/artist/<track count>/<id>
 * content://tech.techyinc.vlc.artwork/media/<last modified>/<id>
 * content://tech.techyinc.vlc.artwork/play_all/artist/<track count>/<id>
 * content://tech.techyinc.vlc.artwork/play_all/genre/<track count>/<id>
 * content://tech.techyinc.vlc.artwork/play_all/playlist/<CRC32 checksum>/<track count>/<id>
 * content://tech.techyinc.vlc.artwork/shuffle_all/<half day expiration time>/<track count>/
 * content://tech.techyinc.vlc.artwork/history/<XOR checksum>/<track count>
 * content://tech.techyinc.vlc.artwork/last_added/<XOR checksum>/<track count>
 *
 * Non-Medialibrary remote cache:
 * content://tech.techyinc.vlc.artwork/remote?path=<encoded uri>
 */
