...
package tech.techyinc.vlc.gui.video.benchmark
 ...
 * Once the buffering is finished, a broadcast is sent to tech.techyinc.vlcbenchmark's service
...
class BenchActivity : ShallowVideoPlayer() {
    ...
    *  extend the length of the benchmark*/
     ...
     * trigger screenshot in tech.techyinc.vlcbenchmark's service
     *
    ...
    companion object {
        ...
        private const val ACTION_TRIGGER_SCREENSHOT = "tech.techyinc.vlcbenchmark.TRIGGER_SCREENSHOT"
        private const val ACTION_CONTINUE_BENCHMARK = "tech.techyinc.vlc.gui.video.benchmark.CONTINUE_BENCHMARK"
