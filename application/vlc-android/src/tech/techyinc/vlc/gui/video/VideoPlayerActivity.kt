...
import tech.techyinc.vlc.gui.audio.EqualizerFragment
import tech.techyinc.vlc.gui.audio.PlaylistAdapter
import tech.techyinc.vlc.gui.browser.EXTRA_MRL
import tech.techyinc.vlc.gui.dialogs.PlaybackSpeedDialog
import tech.techyinc.vlc.gui.dialogs.RenderersDialog
import tech.techyinc.vlc.gui.dialogs.SleepTimerDialog
import tech.techyinc.vlc.gui.helpers.PlayerOptionsDelegate
...
open class VideoPlayerActivity : AppCompatActivity(), PlaybackService.Callback, PlaylistAdapter.IPlayer, OnClickListener, OnLongClickListener, StoragePermissionsDelegate.CustomActionController, TextWatcher, IDialogManager {
    ...
    private val addedExternalSubs = ArrayList<tech.techyinc.vlc.mediadb.models.ExternalSub>()
    private var downloadedSubtitleLiveData: LiveData<List<tech.techyinc.vlc.mediadb.models.ExternalSub>>? = null
    ...
    private val downloadedSubtitleObserver = Observer<List<tech.techyinc.vlc.mediadb.models.ExternalSub>> { externalSubs ->
