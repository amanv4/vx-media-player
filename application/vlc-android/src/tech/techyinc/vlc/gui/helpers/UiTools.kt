...
import tech.techyinc.tools.KEY_APP_THEME
...
import tech.techyinc.vlc.gui.BaseActivity
import tech.techyinc.vlc.gui.InfoActivity
import tech.techyinc.vlc.gui.browser.MediaBrowserFragment
import tech.techyinc.vlc.gui.dialogs.AddToGroupDialog
import tech.techyinc.vlc.gui.dialogs.SavePlaylistDialog
import tech.techyinc.vlc.gui.dialogs.VLCBillingDialog
import tech.techyinc.vlc.gui.dialogs.VideoTracksDialog
import tech.techyinc.vlc.gui.preferences.EXTRA_PREF_END_POINT
...
//        snack.setAnchorView()
    ...
    fun fillAboutView(v: View) {
        val source = v.findViewById<TextView>(R.id.source_link)
        source.text = HtmlCompat.fromHtml(v.context.getString(R.string.about_source_link),
                HtmlCompat.FROM_HTML_MODE_LEGACY)
        source.linksClickable = true;

        val source2 = v.findViewById<TextView>(R.id.vlc_source_link)
        source2.text = HtmlCompat.fromHtml(v.context.getString(R.string.about_source_link_vlc),
                HtmlCompat.FROM_HTML_MODE_LEGACY)
        source2.linksClickable = true;


        val revision = v.context.getString(R.string.build_revision) + " VX Media Player: " + v.context.getString(R.string.build_vlc_revision)
