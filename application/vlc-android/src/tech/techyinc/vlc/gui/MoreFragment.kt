...
import tech.techyinc.resources.ACTIVITY_RESULT_PREFERENCES
import tech.techyinc.tools.*
import tech.techyinc.vlc.BuildConfig
import tech.techyinc.vlc.R
import tech.techyinc.vlc.donations.BillingStatus
import tech.techyinc.vlc.donations.VLCBilling
import tech.techyinc.vlc.gui.helpers.Click
import tech.techyinc.vlc.gui.helpers.ImageClick
import tech.techyinc.vlc.gui.helpers.LongClick
import tech.techyinc.vlc.gui.helpers.SimpleClick
import tech.techyinc.vlc.gui.helpers.UiTools.showDonations
import tech.techyinc.vlc.gui.network.IStreamsFragmentDelegate
import tech.techyinc.vlc.gui.network.KeyboardListener
import tech.techyinc.vlc.gui.network.MRLAdapter
import tech.techyinc.vlc.gui.network.StreamsFragmentDelegate
import tech.techyinc.vlc.gui.preferences.PreferencesActivity
import tech.techyinc.vlc.gui.view.EmptyLoadingState
import tech.techyinc.vlc.gui.view.TitleListView
import tech.techyinc.vlc.interfaces.IHistory
import tech.techyinc.vlc.interfaces.IRefreshable
...
import tech.techyinc.vlc.viewmodels.HistoryModel
...
class MoreFragment : BaseFragment(), IRefreshable, IHistory, IDialogManager,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        shareButton.setOnClickListener {
            ...
            share.putExtra(Intent.EXTRA_SUBJECT, "VX Media PLayer")
            var shareMessage = "\nLet me recommend you this application\n\n"
            shareMessage = shareMessage + "market://details?id=" + BuildConfig.APP_ID + "\n"
        ...
        rateButton.setOnClickListener{
            val url : String = "market://details?id=tech.techyinc.vmp"
            val intent = Intent(Intent.ACTION_VIEW)
            intent.data = Uri.parse(url)
            if(intent.resolveActivity(packageManager!!) != null) {
                startActivity(intent)
            } else {
                val url : String = "https://play.google.com/store/apps/details?id=tech.techyinc.vmp"
                val intent = Intent(Intent.ACTION_VIEW)
                intent.data = Uri.parse(url)
                startActivity(intent)
            }
