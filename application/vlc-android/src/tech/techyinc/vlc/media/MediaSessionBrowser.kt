 ...
 *  *************************************************************************
 */
package tech.techyinc.vlc.media
...
import tech.techyinc.resources.AppContextProvider.appContext
import tech.techyinc.tools.KEY_ARTISTS_SHOW_ALL
import tech.techyinc.tools.PLAYBACK_HISTORY
import tech.techyinc.tools.Settings
import tech.techyinc.vlc.ArtworkProvider
import tech.techyinc.vlc.BuildConfig
import tech.techyinc.vlc.R
import tech.techyinc.vlc.extensions.ExtensionManagerService
import tech.techyinc.vlc.extensions.ExtensionManagerService.ExtensionManagerActivity
import tech.techyinc.vlc.extensions.ExtensionsManager
import tech.techyinc.vlc.extensions.api.VLCExtensionItem
import tech.techyinc.vlc.gui.helpers.UiTools.getDefaultAudioDrawable
import tech.techyinc.vlc.gui.helpers.getBitmapFromDrawable
import tech.techyinc.vlc.isPathValid
import tech.techyinc.vlc.media.MediaUtils.getMediaAlbum
import tech.techyinc.vlc.media.MediaUtils.getMediaArtist
import tech.techyinc.vlc.media.MediaUtils.getMediaDescription
import tech.techyinc.vlc.media.MediaUtils.getMediaSubtitle
import tech.techyinc.vlc.util.ThumbnailsProvider
import tech.techyinc.vlc.util.isSchemeStreaming
import java.util.*
